      ...
      <div className="md:max-w-7xl w-full mx-auto">
        ...
        <div className="bg-[#0B1F3A] text-white md:py-20 py-10 px-4 md:px-20 rounded-3xl">
          ...
          <p className="text-md md:text-xl text-center max-w-2xl mx-auto mb-6">
            At GuardVision, we pride ourselves on providing professional, reliable, and efficient CCTV installation services. With years of experience, we ensure that your property is secure with the latest technology and our expert installation.
          </p>
