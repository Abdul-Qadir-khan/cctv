  ...
  return (
    <section className="w-full min-h-screen bg-gray-50 px-6 md:px-20 py-20 flex flex-col lg:flex-row gap-16">
      ...
      <div className="flex-1 max-w-xl relative select-none">
        <div
          className={`relative overflow-hidden rounded-3xl shadow-xl cursor-zoom-in ${
        ...
        >
          <motion.img
            ...
            className={`w-full h-[450px] object-cover rounded-3xl transition-transform duration-300 ${
      ...
      return (
        <button
          ...
          className={`w-10 h-10 rounded-full border-2 ${
            isSelected ? "border-accent scale-110 shadow-lg" : "border-gray-300"
